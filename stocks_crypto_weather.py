...
def get_price(SCW, api_arg):
    if SCW == "STOCK":
        ...
        + "The city is " + weather_api.generate_name(weather_url) + ", " + weather_api.generate_region(weather_url) + ".\n"
        ...
        print("The city is", weather_api.generate_name(weather_url) + ",", weather_api.generate_region(weather_url), end=".\n")
    else:
...
background_image = tk.PhotoImage(file='wave.png')
